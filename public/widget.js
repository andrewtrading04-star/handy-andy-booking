...
(function () {
  ...
  const ACCENT_LIGHT = { 'handy-andy':'#ff9944', 'mile-high':'#4ade80', 'austin':'#4d7ef0', 'precision':'#4fc3f7', 'tvmountingdenver':'#4da6ff', 'houstonmounting':'#14b8a6', 'houstontvinstallation':'#ef4444', 'tvhanginghouston':'#8b5cf6', 'htvmounting':'#22c55e', 'atxmountpros':'#fb7a3d', 'atxtvmount':'#e0a165', 'austinmountingpros':'#b8934a', 'austintvinstall':'#2fae97', 'houstontvmountingpros':'#e2c37f', 'houstonperfectviewtvmounting':'#3d6bf0' }[BUSINESS] || '#ff9944';
  ...
  const INK      = { 'atxmountpros':'#7c2d12', 'atxtvmount':'#2b2b30', 'austinmountingpros':'#4a3a18', 'austintvinstall':'#0b3d36', 'houstontvmountingpros':'#1f1d19', 'houstonperfectviewtvmounting':'#101826' }[BUSINESS] || '#1a2f6b';
  const INK_DEEP = { 'atxmountpros':'#5a1f0c', 'atxtvmount':'#18181c', 'austinmountingpros':'#2f2410', 'austintvinstall':'#07271f', 'houstontvmountingpros':'#131210', 'houstonperfectviewtvmounting':'#0a1020' }[BUSINESS] || '#12224f';
