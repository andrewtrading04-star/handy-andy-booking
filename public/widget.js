...
(function () {
  ...
  const CONTACT_PHONE = { 'handy-andy':'713-876-9032', 'mile-high':'(720) 799-0036', 'austin':'(737) 381-3800', 'precision':'(346) 394-8137', 'tvmountingdenver':'(983) 204-0866', 'tvmountinglosangeles':'', 'houstonmounting':'(346) 660-4850', 'houstontvinstallation':'(346) 657-0917', 'tvhanginghouston':'(346) 660-4780', 'htvmounting':'(346) 586-8209', 'atxmountpros':'(737) 325-8921', 'atxtvmount':'(737) 380-0921', 'austinmountingpros':'(737) 276-0224', 'austintvinstall':'(737) 317-7658', 'houstontvmountingpros':'(346) 671-0647', 'houstonperfectviewtvmounting':'' }[BUSINESS] ?? '713-876-9032';
  ...
  const ACCENT       = { 'handy-andy':'#ff6600', 'mile-high':'#1d9e75', 'austin':'#1e56e0', 'precision':'#0288d1', 'tvmountingdenver':'#017aff', 'tvmountinglosangeles':'#2e7d32', 'houstonmounting':'#0f766e', 'houstontvinstallation':'#b91c1c', 'tvhanginghouston':'#6d28d9', 'htvmounting':'#166534', 'atxmountpros':'#e8570a', 'atxtvmount':'#c9803d', 'austinmountingpros':'#8a6a2c', 'austintvinstall':'#0d7a68', 'houstontvmountingpros':'#c9a25c', 'houstonperfectviewtvmounting':'#1f4fd8' }[BUSINESS] || '#ff6600';
  const ACCENT_LIGHT = { 'handy-andy':'#ff9944', 'mile-high':'#4ade80', 'austin':'#4d7ef0', 'precision':'#4fc3f7', 'tvmountingdenver':'#4da6ff', 'tvmountinglosangeles':'#5fbf68', 'houstonmounting':'#14b8a6', 'houstontvinstallation':'#ef4444', 'tvhanginghouston':'#8b5cf6', 'htvmounting':'#22c55e', 'atxmountpros':'#fb7a3d', 'atxtvmount':'#e0a165', 'austinmountingpros':'#b8934a', 'austintvinstall':'#2fae97', 'houstontvmountingpros':'#e2c37f', 'houstonperfectviewtvmounting':'#3d6bf0' }[BUSINESS] || '#ff9944';
  ...
  const INK      = { 'tvmountinglosangeles':'#163822', 'atxmountpros':'#7c2d12', 'atxtvmount':'#2b2b30', 'austinmountingpros':'#4a3a18', 'austintvinstall':'#0b3d36', 'houstontvmountingpros':'#1f1d19', 'houstonperfectviewtvmounting':'#101826' }[BUSINESS] || '#1a2f6b';
  const INK_DEEP = { 'tvmountinglosangeles':'#0d2415', 'atxmountpros':'#5a1f0c', 'atxtvmount':'#18181c', 'austinmountingpros':'#2f2410', 'austintvinstall':'#07271f', 'houstontvmountingpros':'#131210', 'houstonperfectviewtvmounting':'#0a1020' }[BUSINESS] || '#12224f';
  const ACCENT_RGB   = { 'handy-andy':'255,102,0', 'mile-high':'29,158,117', 'austin':'30,86,224', 'precision':'2,136,209', 'tvmountingdenver':'1,122,255', 'tvmountinglosangeles':'46,125,50', 'houstonmounting':'15,118,110', 'houstontvinstallation':'185,28,28', 'tvhanginghouston':'109,40,217', 'htvmounting':'22,101,52', 'atxmountpros':'232,87,10', 'atxtvmount':'201,128,63', 'austinmountingpros':'138,106,44', 'austintvinstall':'13,122,104', 'houstontvmountingpros':'201,162,92', 'houstonperfectviewtvmounting':'31,79,216' }[BUSINESS] || '255,102,0';
  ...
  const THANKYOU_URL = {
    ...
    'tvmountinglosangeles': 'https://tvmountinglosangeles.com/thank-you',
    ...
    // Austin lead-gen quad: same hosted brand-aware fallback as the Houston
    // quad until each domain has a confirmed live /thank-you page — flip to
    // https://<domain>/thank-you then.
    'atxmountpros':       'https://handy-andy-booking.vercel.app/thank-you.html?b=atxmountpros',
  ...
  async function doSubmit(root){
    ...
    const _mtvPriceDisc=steppedMultiTvPriceDiscount();
