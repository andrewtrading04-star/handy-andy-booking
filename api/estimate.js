...
async function submit(req, res, db) {
  ...
  if ((biz.slug === 'handy-andy' || biz.slug === 'mile-high' || biz.slug === 'austin' || biz.slug === 'precision'
    || biz.slug === 'atxmountpros' || biz.slug === 'atxtvmount' || biz.slug === 'austinmountingpros' || biz.slug === 'austintvinstall')
    && process.env.HANDY_ANDY_SECRETARY_PHONE) phones.add(process.env.HANDY_ANDY_SECRETARY_PHONE);
