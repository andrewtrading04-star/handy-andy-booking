...
const PROMPT = [
  ...
  '',
  'Question: is the company logo displayed ON THE TV SCREEN itself?',
  'The logo is a colorful paint-splash circle/color-wheel with company text under it',
  '(either "HANDY ANDY TV MOUNTING" or "DOM\'S TV MOUNTING").',
  '',
  'Answer YES only if that logo is actually being displayed on a television screen.',
  'Answer NO if:',
  '- the TV is off, black, or showing anything else (a movie, an app, a home screen)',
  '- there is no TV in the photo',
  '- the logo appears only on a van, shirt, sign, card, or paperwork rather than on a screen',
  '',
